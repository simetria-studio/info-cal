...
@elseif ($theme === 'bootstrap-5')
    <div class="d-flex align-items-center flex-xxl-row flex-column align-items-center mb-5 mt-3">
        @if ($component->paginationVisibilityIsEnabled())
            @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                <div class="mb-xxl-0 mb-xl-5 mb-4 d-flex align-items-center justify-content-sm-start justify-content-center">
                    <span class="me-3 text-gray-600 fs-4 fs-xl-6">@lang('Showing')</span>
                    <select
                            wire:model="perPage"
                            id="perPage"
                ...
                @if ($component->paginationIsEnabled() && $rows->lastPage() > 1)
                    <div class="row flex-md-row-reverse flex-column-reverse mx-0 w-100">
                        ...
                        <div class="col-12 col-xxl-3 col-lg-4 text-center text-lg-end text-gray-600 d-flex align-items-center justify-content-md-start justify-content-center mb-md-0 mb-4 flex-wrap ps-0">
