<div class="modal fade" id="addScheduleNameModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::text('schedule_name', null,['class' => 'form-control','id' => 'scheduleName','placeholder' => __('messages.schedule.schedule_name')]) }}
                </div>
                <div class="mb-5">
            ...
            <div class="modal-footer pt-0">
                {{ Form::submit(__('messages.common.save'),['class' => 'btn btn-primary', 'id'=>'scheduleNameBtn']) }}
