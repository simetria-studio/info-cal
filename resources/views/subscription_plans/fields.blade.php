<div class="row">
    ...
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            {{ Form::label('currency', __('messages.subscription_plan.currency').(':'), ['class' => 'form-label required']) }}
            {{ Form::select('currency', getCurrencies(), null,['class' => 'form-select for_trail_required','id'=>'currency','placeholder'=>__('messages.placeholder.select_currency'), 'required']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            {{ Form::label('price', __('messages.subscription_plan.price').(':'), ['class' => 'form-label required']) }}
    ...
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            {{ Form::label('frequency', __('messages.subscription_plan.plan_type').(':'), ['class' => 'form-label required']) }}
            {{ Form::select('frequency', $planType, null, ['required', 'id' => 'planType','class' => 'form-select for_trail_required', 'required']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            {{ Form::label('trial_days', __('messages.subscription_plan.trail_plan').(':'), ['class' => 'form-label']) }}
