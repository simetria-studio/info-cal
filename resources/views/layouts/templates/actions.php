<script id="actionsTemplates" type="text/x-jsrender">
    <a href="{{:editUrl}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-btn">
    ...
    <a href="#" data-id="{{:id}}" class="delete-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                        <span class="svg-icon svg-icon-3">
